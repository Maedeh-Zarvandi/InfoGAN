...
class BiDiscriminatorLoss(BiGANLoss):
    ...
    def forward(self, output):
        ...
        aux_real_cont = output["aux_real_cont"]
        aux_gen_cont = output["aux_gen_cont"]
        ...
        aux_real_loss = self.cce(aux_real_cont, cls)
        aux_gen_loss = self.cce(aux_gen_cont, cls)
        aux_loss = aux_gen_loss + aux_real_loss

        # print('aux_loss disc:', aux_loss)
        ...
        correct_disc = (real_output + fake_output + aux_loss) / 3
...
class GeneratorEncoderLoss(BiGANLoss):
    ...
    def forward(self, output):
        ...
        # print('aux_loss gen:', aux_loss)

        correct_gen = (real_output - fake_output - aux_loss) / 3
